...
This plugin now supports Litecoin, Dogecoin as well as Bitcoin

### 1. Installation
[OSCommerce](http://www.oscommerce.com/Products) must be installed before installing this plugin.
...
```
https://YOUR_DOMAIN/catalog/ext/modules/payment/gocoin/showtoken.php
```

Set the Application and Callback URL. The Callback URL will be https://YOUR_DOMAIN/catalog/ext/modules/payment/gocoin/showtoken.php<br>
...
1. Install GoCOin Module: In the Admin panel click Module > Payment > Install Module , You will see list of Payment module. Locate GoCoin, and click Install. On Successful installation user is redirected to GoCoin Payment Setting page.<br><br>

2. Configure GoCoin Payment module, by editing and entering<br>
